...
// Schema for buyer insight section
export const buyerInsightSchema = z.object({
...
const BuyerInsightFormContent: React.FC = () => {
...
interface BuyerInsightSectionProps {
  pageType: 'user' | 'vendor' | 'about';
}

export const BuyerInsightSection: React.FC<BuyerInsightSectionProps> = ({ pageType }) => {
  return (
    <BaseSectionForm
      pageType={pageType}
      sectionName="insights"
      schema={buyerInsightSchema}
      title="Buyer Behaviour Insight"
      description="Edit the buyer behaviour insight section content."
    >
      <BuyerInsightFormContent />
    </BaseSectionForm>
  );
};