...
const VendorCtaFormContent: React.FC = () => {
...
interface VendorCtaSectionProps {
  pageType: 'user' | 'vendor' | 'about';
}

export const VendorCtaSection: React.FC<VendorCtaSectionProps> = ({ pageType }) => {
  return (
    <BaseSectionForm
      pageType={pageType}
      sectionName="vendorCta"
      schema={vendorCtaSchema}
      title="Vendor CTA"
      description="Edit the vendor call-to-action section."
    >
      <VendorCtaFormContent />
    </BaseSectionForm>
  );
};