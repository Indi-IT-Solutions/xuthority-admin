...
// Schema for mission support section
export const missionSupportSchema = z.object({
...
const MissionSupportFormContent: React.FC = () => {
...
interface MissionSupportSectionProps {
  pageType: 'about';
}

export const MissionSupportSection: React.FC<MissionSupportSectionProps> = ({ pageType }) => {
  return (
    <BaseSectionForm
      pageType={pageType}
      sectionName="missionSupport"
      schema={missionSupportSchema}
      title="Mission/Support Section"
      description="Add, edit data to Mission/Support Section on the about page."
    >
      <MissionSupportFormContent />
    </BaseSectionForm>
  );
}; 